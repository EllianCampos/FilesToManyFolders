Files to Many Folder solver a specific problem when you have a lot of files (for exmple images and vides) in single folder that make it very hard to view and load by an smart phone.
